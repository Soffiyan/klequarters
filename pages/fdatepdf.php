...
Demand Notice For (Office-use)<br>Fine Charges Date Wise Report From - '.$from.' --- To - '.$to.'<br /><br />
    ...
    $obj_pdf->Output('Fine-Report .pdf', 'I');
}
?>
<?php
