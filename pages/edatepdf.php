...
if (isset($_POST["create_pdf"])) {
    ...
    $obj_pdf->SetTitle("Electrical-Report");
...
Demand Notice For (Office-use)<br>Electrical Fees Report Date Wise  From - ' . $from . ' --- To - ' . $to . '<br /><br />
      <table border="1" cellspacing="0" cellpadding="5">  
           ...
           <tr>  
                                ...
                                <th width="10%">From</th>
                                <th width="10%">To</th>
                                <th width="10%">Electrical Fees</th>
    ...
    $obj_pdf->Output('Electrical report .pdf', 'I');
}
?>
<?php
