...
<script>
    ...
    function get_date_wise_vacate(val) {
...
<div class="content-wrapper">
    ...
    <div class="row">
        <div class="container-fluid">
            <div class="card">
                <form class="form-horizontal" method = "post" action = "?page=vacate_datewise&action=add" enctype="multipart/form-data">
                    <div class='row'>
                        <fieldset>
                            ...
                            <div class="col-lg-3 hidden-print">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" id="demoDate1" name="to_date" type="text" placeholder="Select To Date" required="" onchange="get_date_wise_vacate(this.value);">
