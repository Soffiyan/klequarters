...
function fetch_data() {
    ...
    $from = $_GET['from'];
    $to = $_GET['to'];
    $sql = "select * from update_qtr where `payment_date` between '$from' and '$to' and status='' and vacate_date=''";
...
if (isset($_POST["create_pdf"])) {
    ...
    $obj_pdf->SetTitle("$from - $to Payment Report");
...
<br>Payment Report';
    ...
    $dates = date('d-m-Y');
    $obj_pdf->Output(''.$from.'  '.$to.' payment.pdf', 'I');
}
?>
<?php
