...
if (isset($_POST["create_pdf"])) {
    ...
    $obj_pdf->SetTitle("Miscellaneous report");
...
Demand Notice For (Office-use)<br>Miscellaneous Fees Report Date Wise  From - '.$from.' --- To - '.$to.'<br /><br />
      <table border="1" cellspacing="0" cellpadding="5">  
           ...
           <tr>  
                                ...
                                <th width="10%">From</th>
                                <th width="10%">To</th>
                                <th width="10%">Miscellaneous Charges</th>
    ...
    $obj_pdf->Output('Miscellaneous .pdf', 'I');
}
?>
<?php
