...
$result = mysql_query("SELECT SUM(maint) AS value_sum FROM registration  where payment='paid'");
...
<div class="content-wrapper">
    <div class="page-title">
        <div>
            <h1>Maintainence Charges</h1>
        </div>  
        <form method="post" action="pages/maintpdf.php?sum=<?php echo"$sum"; ?>">
    ...
    <div class="row">
        <div class="container-fluid">
            <div class="card">
                <fieldset>
                    <form name = "form" onsubmit="return validation()" method = "post" action="?page=maintreport&action=add"  enctype="multipart/form-data" >
