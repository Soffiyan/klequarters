...
$result = mysql_query("SELECT SUM(shop_rent) AS value_sum FROM registration  where payment='paid'");
...
<div class="content-wrapper">
    <div class="page-title">
        <div>
            <h1>Service Tax Charges</h1>
        </div> 
        <form method="post" action="pages/servicepdf.php?sum=<?php echo"$sum"; ?>">
    ...
    <div class="row">
        <div class="container-fluid">
            <div class="card">
                <fieldset>
                    <form name = "form" onsubmit="return validation()" method = "post" action="?page=servicereport&action=add"  enctype="multipart/form-data" >
