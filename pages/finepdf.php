...
Demand Notice For (Office-use)<br>Late/Fine/Penalty Complete Fees Report Date - ' . $dates . '<br /><br />
      <table border="1" cellspacing="0" cellpadding="5">  
           ...
           <tr>  
                                ...
                                <th width="10%">From</th>
                                <th width="10%">To</th>
                                <th width="10%">Late/Penalty-Fees</th>
    ...
    $obj_pdf->Output('Late/Fine' . $dates . '.pdf', 'I');
}
?>
<?php
