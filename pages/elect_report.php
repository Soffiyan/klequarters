...
$result = mysql_query("SELECT SUM(elect_charges) AS value_sum FROM registration  where payment='paid'");
...
<div class="content-wrapper">
    <div class="page-title">
        <div>
            <h1>Electrical Charges</h1>
        </div>
        <form method="post" action="pages/electpdf.php?sum=<?php echo"$sum"; ?>">
    ...
    <div class="row">
        <div class="container-fluid">
            <div class="card">
                <fieldset>
                    <form name = "form" method = "post" action="?page=electreport&action=add"  enctype="multipart/form-data" >
