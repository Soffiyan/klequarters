...
if (isset($_POST["create_pdf"])) {
    ...
    $obj_pdf->SetTitle("Total Fees report");
...
Demand Notice For (Office-use)<br>Total Fees Complete Fees Report Date - ' . $dates . '<br /><br />
    ...
    $obj_pdf->Output('Total Report' . $dates . '.pdf', 'I');
}
?>
<?php
