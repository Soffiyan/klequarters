...
<div class="content-wrapper">
    <div class="page-title">
        <div>
            <h1>Commercial Shop Rent</h1>
        </div>  
        <form method="post" action="pages/commerpdf.php?sum=<?php echo"$sum"; ?>">
    ...
    <div class="row">
        <div class="container-fluid">
            <div class="card">
                <fieldset>
                    <form name = "form" method = "post" action="?page=comreport&action=add"  enctype="multipart/form-data" >
