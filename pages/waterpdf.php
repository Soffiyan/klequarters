...
if (isset($_POST["create_pdf"])) {
    ...
    $obj_pdf->SetTitle("Water Charges Report");
...
Demand Notice For (Office-use)<br>Water Complete Fees Report Date - '.$dates.'<br /><br />
    ...
    $obj_pdf->Output('Water' . $dates . '.pdf', 'I');
}
?>
<?php
