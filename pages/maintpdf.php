...
if (isset($_POST["create_pdf"])) {
    ...
    $obj_pdf->SetTitle("Maintainence Charges Report");
...
Demand Notice For (Office-use)<br>Maintainence Complete Fees Report Date - '.$dates.'<br /><br />
    ...
    $obj_pdf->Output('Maintainance' . $dates . '.pdf', 'I');
}
?>
<?php
