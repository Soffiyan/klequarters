...
$result = mysql_query("SELECT SUM(deposit) AS value_sum FROM registration  where payment='paid'");
...
<div class="content-wrapper">
    <div class="page-title">
        ...
        <form method="post" action="pages/deppdf.php?sum=<?php echo"$sum"; ?>">
    ...
    <div class="row">
        <div class="container-fluid">
            <div class="card">
                <fieldset>
                    <form name = "form" onsubmit="return validation()" method = "post" action="?page=depositreport&action=add"  enctype="multipart/form-data" >
