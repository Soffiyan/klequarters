...
if (isset($_POST["create_pdf"])) {
    ...
    $obj_pdf->SetTitle("Shop Rent report");
...
Demand Notice For (Office-use)<br>Commercial Shop Rent Complete Fees Report Date - ' . $dates . '<br /><br />
    ...
    $obj_pdf->Output('Commercial-Shop-Rent' . $dates . '.pdf', 'I');
}
?>
<?php
