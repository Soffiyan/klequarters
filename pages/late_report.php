...
$result = mysql_query("SELECT SUM(fine) AS value_sum FROM registration  where payment='paid'");
...
<div class="content-wrapper">
    <div class="page-title">
        ...
        <form method="post" action="pages/finepdf.php?sum=<?php echo"$sum"; ?>">
    ...
    <div class="row">
        <div class="container-fluid">
            <div class="card">
                <fieldset>
                    <form name = "form" onsubmit="return validation()" method = "post" action="?page=latereport&action=add"  enctype="multipart/form-data" >
