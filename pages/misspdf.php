...
function fetch_data() {
    ...
    $output = '';
    $output1 = '';
    $sql = "SELECT * FROM registration WHERE payment='paid' order by id desc";
...
if (isset($_POST["create_pdf"])) {
    ...
    $obj_pdf->SetTitle("Service Tax report");
...
Demand Notice For (Office-use)<br>Missellaneous Fees Complete Fees Report Date - ' . $dates . '<br /><br />
      <table border="1" cellspacing="0" cellpadding="5">  
           ...
           <tr>  
                                ...
                                <th width="10%">From</th>
                                <th width="10%">To</th>
                                <th width="10%">Missellaneous Fees</th>
    ...
    $obj_pdf->Output('Missellaneous' . $dates . '.pdf', 'I');
}
?>
<?php
