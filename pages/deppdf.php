...
if (isset($_POST["create_pdf"])) {
    ...
    $obj_pdf->SetTitle("Deposit report");
...
Demand Notice For (Office-use)<br>Deposit Fees Complete Fees Report Date - ' . $dates . '<br /><br />
    ...
    $obj_pdf->Output('Deposit' . $dates . '.pdf', 'I');
}
?>
<?php
