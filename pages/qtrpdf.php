...
if (isset($_POST["create_pdf"])) {
    ...
    $obj_pdf->SetTitle("Quartersreport");
...
Demand Notice For (Office-use)<br>Quarters Complete Fees Report Date - '.$dates.'<br /><br />
    ...
    $obj_pdf->Output('Quartersreport' . $dates . '.pdf', 'I');
}
?>
<?php
