...
Demand Notice For (Office-use)<br>Mees Fees Complete Fees Report Date - ' . $dates . '<br /><br />
    ...
    $obj_pdf->Output('Mess' . $dates . '.pdf', 'I');
}
?>
<?php
