...
$result = mysql_query("SELECT SUM(water_charges) AS value_sum FROM registration  where payment='paid'");
...
<div class="content-wrapper">
    <div class="page-title">
        ...
        <form method="post" action="pages/waterpdf.php?sum=<?php echo"$sum"; ?>">
    ...
    <div class="row">
        <div class="container-fluid">
            <div class="card">
                <fieldset>
                    <form name = "form" method = "post" action="?page=waterreport&action=add"  enctype="multipart/form-data" >
