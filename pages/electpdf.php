...
if (isset($_POST["create_pdf"])) {
    ...
    $obj_pdf->SetTitle("Electrical Charges Report");
...
Demand Notice For (Office-use)<br>Electrical Complete Fees Report Date - '.$dates.'<br /><br />
      <table border="1" cellspacing="0" cellpadding="5">  
           ...
           <tr>  
                                ...
                                <th width="10%">From</th>
                                <th width="10%">To</th>
                                <th width="10%">Electrical Charges</th>
    ...
    $obj_pdf->Output('Electrical' . $dates . '.pdf', 'I');
}
?>
<?php
